/**
 * @file binarytree.h
 * Declaraction of the BinaryTree class. You will not need to modify this.
...
class BinaryTree
{
  ...
  private:
    ...
    //NEW: private helper function for the public printLeftToRight function
    void printLeftToRight(const Node* subRoot) const;
    
    //NEW: private helper function for the public mirror function
    void mirror(Node*& subRoot);
    
    //NEW: private helper function for the public printPaths function
    void printPaths(const Node* subRoot, string prevPath) const;
    
    //NEW: private helper function for the public sumDistances function
    int sumDistances(const Node* subRoot, int prevDist) const;
    
    //NEW: private helper function for the public isOrdered function
