...
LinkedList::LinkedList() : length(0), front(NULL), back(NULL) {}

LinkedList::LinkedList(const LinkedList& ll) : length(0), front(NULL), back(NULL) { copyList(ll); }

LinkedList::~LinkedList() { deleteList(); }
