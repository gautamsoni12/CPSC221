...
{
    std::transform(word1.begin(), word1.end(), word1.begin(), [](unsigned char c) -> unsigned char { return std::toupper(c); });
    std::transform(word2.begin(), word2.end(), word2.begin(), [](unsigned char c) -> unsigned char { return std::toupper(c); });

    auto a = dict.find(word1);
    auto b = dict.find(word2);

    if ((a!= dict.end()) && (b!= dict.end())){
